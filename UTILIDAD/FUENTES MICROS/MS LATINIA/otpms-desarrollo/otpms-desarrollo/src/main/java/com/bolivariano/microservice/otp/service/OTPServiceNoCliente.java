...
public class OTPServiceNoCliente {
	...
	public GenerarOTPMensajeResponse generarOTPNoCliente(String proceso, GenerarOTPMensajeRequest request)	throws OTPException {
		...
		return OTPException.mensajeGenerarOTP(
				0,
