...
'        End If
  ...
  If impresiones > 0 Then
    For j = 1 To impresiones
        ...
        PMSetLineaImpresion "v" + "Autorizacion SRI: " & Format(txtLogRevSri.Text, "#####0") + " Placa: " + Mid(Trim(Matricula), 1, 10) + " "
        'hy-->
        'PMSetLineaImpresion "v" + "Motor:" + Trim(txtMotor.Text) + " Chasis: " + Trim(txtChasis.Text)
        PMSetLineaImpresion "v" + "Chasis: " + Trim(txtChasis.Text)
        '<--hy
        PMSetLineaImpresion "v" + "Nuevo Propietario: " + Mid$(Trim(TxtNomProp), 1, 25)
        PMSetLineaImpresion "v" + "Ced/Ruc/Pas nuevo prop: " + FMEspaciosATX(Mid((cedula.Text), 1, 14), 14, CGJustificacionIzquierda)
        ...
        End If
        PMSetLineaImpresion "v" + "Total: " + FMEspaciosATX("us$" + Format((Total + administracion), "##,###,##0.00"), 13, CGJustificacionDerecha)
