		...
		<ns2:entradaEjecutarPago xmlns:ns2="http://www.bolivariano.com/mensaje/MensajeOTC">
			...
			<ns2:servicio>
				...
				<codigoTipoIdentificador>
					<xsl:choose>
						<xsl:when test="/ns6:entradaEjecutarPago/ns6:servicio/codigoTipoIdentificador = 'CED'">
						  <xsl:text disable-output-escaping="no">002</xsl:text>
						</xsl:when>
						<xsl:when test="/ns6:entradaEjecutarPago/ns6:servicio/codigoTipoIdentificador = 'RUC'">
