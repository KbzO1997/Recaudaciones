...
Public Sub PLReverso()
    ...
    ElseIf Trim(txtCampo(1).Text) = 18786 Then 'KBastida
        ...
        If (Me.txtCampo(0) = "CIT") Then
            Me.txtCampo(0) = 1
        ElseIf (Me.txtCampo(0) = "CDP") Then
            Me.txtCampo(0) = 2
        Else
            Me.txtCampo(0) = 3
        End If
...
On Error GoTo error
    Dim Aviso24 As String
    '***************** VALIDACION UN SOLO PAGO***********
    Aviso24 = "Aviso: Sólo puede elegir una forma de pago"
    If Me.Debito > 0 And Me.efe > 0 Then
        MsgBox Aviso24
        FLTransmitir_ANT_pago = False
        Exit Function
    End If
    If Me.Debito > 0 And Me.Loc > 0 Then
        MsgBox Aviso24
        FLTransmitir_ANT_pago = False
        Exit Function
    End If
    If Me.efe > 0 And Me.Loc > 0 Then
        MsgBox Aviso24
        FLTransmitir_ANT_pago = False
        Exit Function
    End If
    ...
    If CCur(Loc.Text) > 0 Then
        VLTPCuenta = "CH"
    End If
    
    If CCur(efe.Text) > 0 Then
        VLTPCuenta = "EF"
    End If
    ...
    If Me.Cta.ClipText <> "" Then
        ...
        PMPasoValoresATX VGSqlConn, "@i_cuenta", 0, SQLVARCHAR, (Cta.ClipText), "Cta", ""
    Else
        PMPasoValoresATX VGSqlConn, "@i_tipo_cta", 0, SQLVARCHAR, (VLTPCuenta), "TipoCta", ""
        PMPasoValoresATX VGSqlConn, "@i_cuenta", 0, SQLVARCHAR, (VLCta_com), "Cuenta", ""
    End If
    PMPasoValoresATX VGSqlConn, "@i_cheque", 0, SQLMONEY, (Loc.Text), "Cheques", ""
    If CantChq.Text = "" Then
