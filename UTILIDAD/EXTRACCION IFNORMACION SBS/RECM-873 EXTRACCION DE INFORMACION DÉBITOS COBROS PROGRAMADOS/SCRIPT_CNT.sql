...
hs_cta_banco CTA, case when cc_cta_banco is not null then 'CTE' when ah_cta_banco is not null then 'AHO' else hs_tipocta end TIPO,  hs_referencia ANYPAGADOR
...
AND hs_tipo_transaccion = 43547
AND hs_tsfecha >= '11/01/2023'
AND hs_tsfecha < '01/01/2024'
AND hs_tipo_contable in ('3','4')


SELECT DISTINCT MES, NOMBRE, IDENTIFICACION, CTA, TIPO, ANYPAGADOR
