...
/*              MODIFICACIONES                                          */
/*    FECHA       AUTOR          RAZON                                  */
/*    16/Feb/2011 German Medina  Emisi�n inicial MGL-309-CU-1830        */
...
/*10 18-Ene-2016  Mar�a Jos� Silva  ETAPA-AP-SGC00018437-SGC00018451 Comisi�n de Etapa*/
/*   15/Febrero/2016 smerino   	  RECBEL-AP-SGC00016734-SGC00016737     */
/*12 07/Abril/2016 Mar�a Jos� Silva  SGC00023538  Enviar alerta     */
...
/*16 16/Feb/2017   Daniel Pereira RECA-CC-SGC00027934 Cobro Comisi�n ND Ventanilla */
/*17 15/Mar/2017   Daniel Pereira RECA-CC-SGC00027715 Cobro Comisi�n ND Ventanilla */
/*18 04/May/2017   Mar�a Jos� Silva RECA-CE-SGC00028529 Colocar default CTE en la variable @i_tipo_cta */
/*19  18/May/2017  Mar�a Jos� Silva    Cobro de Comisi�n TVCABLE RECA-CC-SGC00027895  */
/*20  31/Ago/2017  Jonathan Lopez Torres Deflactacion de Boton de Pago por Corriente */
/*21  26/Dic/2017  Mar�a Jos� Silva   RECA-CE-SGC00030685 Validar que existe el pago antes de realizar el reverso  */
/*22  05/Sept/2018  Maria Jose Silva     RECA-CC-SGC00032726        */
/*23  14/Feb/2019	Mar�a Jos� Silva	MGLOB-4 Recaudacion Marglobal*/
...
/*26  05/Feb/2021  Josu� Rocafuerte RECMPS-401   Descripcion para canal SAT de Notificaciones Latinia */
/*27  23/Mar/2021  Josu� Rocafuerte RECMPS-685   Agregar Empresas TVCable y Megadatos a la Notificacion de Latinia */
/*28  27/Oct/2021  Josu� Rocafuerte RECM-416 Agregar Empresas Catalogo de Empresas TVCable */
/*29  17/05/2022   Kevin Bastidas   RECM-501 XTRIMTV CABLE PAGOS PARCIALES VENTANILLA*/
/************************************************************************/
...
begin
    ...
    begin
        exec cobis..sp_cerror
            ...
            @t_file          = @t_file,
            @t_from          = @w_sp_name,
            @i_msg           = 'NO EXISTE TRANSACCI�N ORIGINAL',
            @i_num           = 34014
        return 34014
    end
    
    --Valida si el secuencial de correcci�n ya que encuentra ingresado para los reversos
    if @i_empresa = "7256"
    begin
	...
	if @i_empresa in ('1707','1708','6951','6952')
		...
		if @i_empresa = '6388'
		   ...
		   if @i_empresa = '8461'
			...
			select @w_desc_empresa ='TVCABLE' , @w_servicio_desc = 'FACTURA' , @w_motivo = 'FACTURA', @o_tipo_serv = 'FACTURA'
		else /* FIN REF27 */
		    select @w_desc_empresa ='SERVICIOS VARIOS' , @w_servicio_desc = 'PAGO FACT.', @w_motivo = 'SERVICIOS VARIOS' , @o_tipo_serv = 'FACTURA' --RECM-501 Kbastida Add @o_tipo_serv
