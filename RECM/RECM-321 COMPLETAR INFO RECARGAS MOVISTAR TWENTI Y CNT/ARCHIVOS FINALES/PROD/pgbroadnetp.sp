...
--Conciliacion desde el batch
 ...
 begin tran	
  ...
  --y generar el macth con la tabla: pag_t_concilia_broadnet
      ...
      tmp.hl_autorizacion = co_num_ref 
      --and co_valor = tmp.ai_debito 
...
go
--grant execute on pa_pag_a_concilia_broadnet_p to apl_osb_hpdes
--grant execute on pa_pag_a_concilia_broadnet_p to apl_osb_hpact
go
