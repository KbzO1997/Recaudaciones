...
/* 76 27/Nov/2023 Kevin Bastidas	RECMPS-2834 ECUANET VENTANILLA A06 */
/****************************************************************************************/
...
where hs_tsfecha >= @i_fecha_ini
  ...
  and hs_causa in("1") --KBastidz Marglobal
  and hs_correccion = 'S'
   and hs_terminal <> 'ATMB'  --ref 45
