    ...
    <ns15:salidaEjecutarPago>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <ns15:montoTotal><xsl:value-of select="/ns7:salidaEjecutarPago/ns7:montoTotal"/></ns15:montoTotal>
          <ns15:referencia>
            <xsl:value-of select= '/ns7:salidaEjecutarPago/ns7:datosAdicionales/ns7:datoAdicional[codigo = "rp_s_ssn"]/valor'/>
          </ns15:referencia>
          <ns15:fechaDebito>
            <xsl:value-of
              select='java:format(java:text.SimpleDateFormat.new("yyyy-MM-dd&apos;T&apos;HH:mm:ss"), java:util.Date.new())' />
          </ns15:fechaDebito>
          <ns15:fechaPago>
