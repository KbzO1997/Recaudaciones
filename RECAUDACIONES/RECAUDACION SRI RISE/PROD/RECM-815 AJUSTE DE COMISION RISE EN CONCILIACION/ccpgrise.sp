...
/*  Procesamiento:      OLTP                                            */
/*  Ult.ControlTarea:   J-RECM-815                                 		*/
/*  Ult.Referencia:     REF 16                                          */
/************************************************************************/
/*                                IMPORTANTE                            */
...
/*16  23/Nov/2023  Kevin Bastidas  RECM-815   Ajuste de comision RISE en la conciliacion*/
/************************************************************************/
...
select @w_hora_deb = convert(varchar(8),getdate(),108)  -- HORA debito
 ...
 /*REF9 fin SMM */
   ...
   /*REF9 Fin SMM */
    ...
    --<REF 16 Add w_comi_total comison auxiliar
	if @i_canal = 'VEN' and @i_comision_efe > 0
		begin
			select @w_comi_total = isnull(@i_comision_efe,0) + isnull(@i_comision_chq,0) + isnull(@i_comision_tot,0) ----SMERINO CNBIII
		end
	--REF 16>	
   ...
   */
   ...
   0, 0, '0', '0', '0', 0,  --<REF 16 Remover w_comi_total REF 16>
    /*REF9 INICIO SMM */
