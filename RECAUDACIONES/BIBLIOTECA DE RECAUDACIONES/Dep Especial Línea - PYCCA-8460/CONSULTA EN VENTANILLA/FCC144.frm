...
'        End If
    ...
    If Me.txt_empresa.Text = "8460" Then 'jg RECMPS-272
      vl_tipo_cons = "1"
    End If
...
Function FLTransmitir_pago_Ecuaquimica() As Boolean
    ...
    If VGTipoEjecucion = CGNormal% Then
        If Me.txt_empresa.Text <> "9291" And Me.txt_empresa.Text <> "8460" Then  ' RECMPS-223 JG
    ...
    Next I%
    '-------pholguiv
    PMPasoValoresATX VGSqlConn, "@i_denominaciones", 0, SQLVARCHAR, CStr(vldenominacion), "denom", ""
