...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<mcnel:MensajeEntradaReversar>
			...
			<tipoIdentificacion>
				<xsl:value-of select="/ns8:entradaEjecutarReverso/ns8:servicio/codigoTipoIdentificador"/>			
			</tipoIdentificacion>
			...
			<fechaPago>
				<xsl:value-of select="concat(substring(/ns8:entradaEjecutarReverso/ns8:fechaPago,6,2),'/', substring(/ns8:entradaEjecutarReverso/ns8:fechaPago,9,2),'/', substring(/ns8:entradaEjecutarReverso/ns8:fechaPago,1,4)) "/>				
			</fechaPago>
			...
			<secuencialReverso><xsl:value-of select="/ns6:entradaEjecutarReverso/ns6:recibos/ns6:recibo/referencia"/></secuencialReverso>
