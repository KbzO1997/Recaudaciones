...
DECLARE
  ...
  LV_EMPRESA 				VARCHAR2(50) := 'UNIV. CATOLICA DE CUENCA';
...
/
	...
	select EMP_CODIGO from DB_OTC.OTC_M_EMPRESA  where EMP_CODIGO = '1348';
	select CNV_CODIGO from DB_OTC.OTC_M_CONVENIO  where CNV_CODIGO = '1348';
	select SRV_NOMBRE from DB_OTC.OTC_D_SERVICIO where SRV_NOMBRE = '1348';
	select END_NOMBRE from DB_OTC.OTC_M_PUNTO_FINAL where END_NOMBRE = 'UNIV. CATOLICA DE CUENCA CONSULTA';
	select END_NOMBRE from DB_OTC.OTC_M_PUNTO_FINAL where END_NOMBRE = 'UNIV. CATOLICA DE CUENCA PAGO';
