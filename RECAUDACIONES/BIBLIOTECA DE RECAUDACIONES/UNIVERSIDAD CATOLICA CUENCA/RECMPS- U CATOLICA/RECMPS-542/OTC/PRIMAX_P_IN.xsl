		...
		<mcnel:MensajeEntradaPagar>
			...
			<xsl:choose>
				<xsl:when test="/ns8:entradaEjecutarPago/ns8:canal='SAT'">
					<fecCont>
						<xsl:value-of select='/ns8:entradaEjecutarPago/ns8:datosAdicionales/ns8:datoAdicional[codigo = "fecCont"]/valor'/>
					</fecCont>

					<tipDoc>
						<xsl:value-of select='/ns8:entradaEjecutarPago/ns8:datosAdicionales/ns8:datoAdicional[codigo = "tipDoc"]/valor'/>
					</tipDoc>

					<numDoc>
						<xsl:value-of select='/ns8:entradaEjecutarPago/ns8:datosAdicionales/ns8:datoAdicional[codigo = "numDoc"]/valor'/>
					</numDoc>
				</xsl:when>
				<xsl:otherwise>
					<fecCont>
						<xsl:value-of select="/ns8:entradaEjecutarPago/ns8:recibos/ns8:recibo/fecha"/>
					</fecCont>

					<tipDoc>
						<xsl:value-of select="/ns8:entradaEjecutarPago/ns8:recibos/ns8:recibo/secuencia"/>
					</tipDoc>

					<numDoc>
						<xsl:value-of select="/ns8:entradaEjecutarPago/ns8:recibos/ns8:recibo/identificador"/>
					</numDoc>
				</xsl:otherwise>
			</xsl:choose>
