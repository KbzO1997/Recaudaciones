...
and dp_empresa   = 1
  ...
  --and dp_cuenta like "549005%"  --Re10 comentar
...
--Ref10 pholguiv comentar este segumento de codigo para colocar un solo script relacionadolo con ctalgo de ctas contables

/*union

select distinct tc_tipo_tran, tc_causa_org,tc_contabiliza,dp_cuenta,tc_perfil,dp_producto,dp_debcred

from cob_remesas..re_tran_contable,cob_conta..cb_det_perfil, cob_conta..cb_perfil
...
and dp_empresa   = 1
  ...
  and dp_cuenta like "299090150522"
...
and ts_tsfecha='02/25/2021'

--and ts_secuencial  in (95196049,95195066,95195760)
