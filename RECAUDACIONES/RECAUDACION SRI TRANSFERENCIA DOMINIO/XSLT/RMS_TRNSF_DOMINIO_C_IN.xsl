  ...
  <ns2:entradaConsultarDeuda xmlns:ns2="http://www.bolivariano.com/mensaje/MensajeOTC">
    ...
    <ns2:servicio>
      ...
      <datosAdicionales>
        <datoAdicional>
          <codigo>e_srv</codigo>
          <valor><xsl:value-of select='/ns8:entradaConsultarDeuda/ns8:servicio/datosAdicionales/datoAdicional[codigo = "s_srv"]/valor'/></valor>
        </datoAdicional>
        <datoAdicional>
          <codigo>e_term</codigo>
          <valor><xsl:value-of select='/ns8:entradaConsultarDeuda/ns8:servicio/datosAdicionales/datoAdicional[codigo = "s_term"]/valor'/></valor>
        </datoAdicional>
        <datoAdicional>
          <codigo>e_rol</codigo>
          <valor><xsl:value-of select='/ns8:entradaConsultarDeuda/ns8:servicio/datosAdicionales/datoAdicional[codigo = "s_rol"]/valor'/></valor>
        </datoAdicional>
        <datoAdicional>
        ...
        <datoAdicional>
          <codigo>e_total</codigo>
          <valor>0</valor>
        </datoAdicional>
        <datoAdicional>
          <codigo>e_tipo_cta</codigo>
          <valor>0</valor>
        </datoAdicional>
        <datoAdicional>
          <codigo>e_cuenta</codigo>
          <valor><xsl:text disable-output-escaping="no"></xsl:text></valor>
        </datoAdicional>
        <datoAdicional>
        ...
        <datoAdicional>
          <codigo>e_ubi</codigo>
           <valor><xsl:value-of select='/ns8:entradaConsultarDeuda/ns8:datosAdicionales/ns8:datoAdicional[codigo = "i_ubi"]/valor'/></valor>
        </datoAdicional>
        <datoAdicional>
