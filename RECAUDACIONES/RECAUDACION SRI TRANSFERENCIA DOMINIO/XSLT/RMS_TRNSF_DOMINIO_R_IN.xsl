...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<ns2:entradaEjecutarReverso xmlns:ns2="http://www.bolivariano.com/mensaje/MensajeOTC">
			...
			<xsl:variable name="codigoEmpresa" select='/ns6:entradaEjecutarReverso/ns6:servicio/datosAdicionales/datoAdicional[codigo = "codigoEmpresa"]/valor' />
			<ns2:canal>
			...
			<ns2:tipoCuenta>
				...
				<xsl:choose>
					<xsl:when test='/ns6:entradaEjecutarReverso/ns6:datosAdicionales/ns6:datoAdicional[codigo = "MPA_TC"]'>
						...
						<xsl:when test='/ns6:entradaEjecutarReverso/ns6:datosAdicionales/ns6:datoAdicional[codigo = "MPA_TC"]'>
							<datoAdicional>
								...
								<valor>
									<xsl:choose>
										<xsl:when test="/ns6:entradaEjecutarReverso/ns6:canal = 'VEN'">
										  <xsl:value-of select='/ns6:entradaEjecutarReverso/ns6:datosAdicionales/ns6:datoAdicional[codigo = "e_tarjeta"]/valor'/>
										</xsl:when>
										<xsl:otherwise>
										  <xsl:value-of select="/ns6:entradaEjecutarReverso/ns6:valorPago"/>                          
										</xsl:otherwise>
