...
/*  Ult.ControlTarea:   J-RECESABREC-86                                 */
/*  Ult.Referencia:     REF 61                                           */
/************************************************************************/
/*                                IMPORTANTE                            */
...
--> ********** <--
 ...
 --<REF 62, KBastida Reporte A06 Canal O Por TC INI Ref62 
select
	@i_producto		   	= 3,
	@i_canal		         = 'O',
	@i_servicio     	   = 'TA01610000',
...
---Ref50 agrega validacion de existencia
   ...
   insert into cob_super..cc_detalle_a06
    ...
    values (@i_producto, @i_fecha_fin, @i_canal,
            ...
            null, null, substring(@i_servicio, 1, 2),
            @i_tipo_cliente, isnull(@cont, 0), @i_tarifa, round(isnull(@valor, 0)/@w_porcIva,2),
            '','','',round(isnull(@valor, 0)/@w_porcIva,2),round(isnull(@valor, 0)/@w_porcIva,2),isnull(@valor,0) - round(isnull(@valor,0)/@w_porcIva,2)    --Ref50 campos valores
            )
   if @@error <> 0
     begin
        exec cobis..sp_cerror
