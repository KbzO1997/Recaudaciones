...
'        End If
  ...
  'If Not FMFormatPagina(VGparformato$, VGparlong$, VGpartop$, VGparleft$, VGparrig$) Then
    ...
    For ina = 1 To Me.grdGrid.Rows - 1
       ...
       PMSetDetalle "v" + Trim$(VLTitulo1) + String(39 - Len(Trim$(VLTitulo1)), " ") + FMEspaciosATX("us$" + Format(VLValor1, "##,###,##0.00"), 18, CGJustificacionDerecha)  'ame 12/06/2011
    Next ina
   End If
...
'           MsgBox "Cliente tiene facturación electrónica imprimir comprobante por 24Online", vbInformation, "Sistema"
    ...
    If VGTipoEjecucion <> CGReverso Then
        If Tarjeta > 0 And VLFlagMultiFlujo = "S" Then
            ...
            'joel
            PMSetDetalle "v" + " "
            PMSetDetalle "v" + "BASE CONSUMO TARIFA 0% :" + FMEspaciosATX("us$" + Format((Tarjeta.Text), "##,###,##0.00"), 9, CGJustificacionDerecha)
            PMSetDetalle "v" + "BASE CONSUMO TARIFA 12%:" + FMEspaciosATX("us$" + Format("0", "##,###,##0.00"), 9, CGJustificacionDerecha)
            PMSetDetalle "v" + "SUBTOTAL CONSUMO       :" + FMEspaciosATX("us$" + Format("0", "##,###,##0.00"), 9, CGJustificacionDerecha)
            ...
            PMSetDetalle "v" + "SUBTOTAL       :" + FMEspaciosATX("us$" + Format("0", "##,###,##0.00"), 18, CGJustificacionDerecha)
