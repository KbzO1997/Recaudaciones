...
/*  Procesamiento: 		OLTP	                                       */
/*  Ult.ControlTarea:   J-RECMPS-2308                       		*/
/*  Ult.Referencia:     REF 05                          		 */
...
/* 05   19/Jul/2023  Luis Cepeda    RECMPS-2308 REPORTES PAGO DE SERVICIOS CON PAGO ROTATIVO CON TC*/
/************************************************************************/
...
if exists(select 1 from db_temporal..sysobjects where name='cc_tran_servicio_tmp' and type = 'U')
  ...
  select ts_secuencial,ts_tipo_transaccion,ts_tsfecha,ts_usuario,
	...
	--ref04 Inicio
	 ...
	 --ref04 Fin
	 ts_ocasional,ts_tipo_chequera,ts_aporte_iess,ts_descuento_iess,ts_fonres_iess,ts_plazo /*<REF 05 se agrega el plazo REF 05>*/
 ...
 union all
    select ts_secuencial = hs_secuencial,ts_tipo_transaccion = hs_tipo_transaccion,ts_tsfecha = hs_tsfecha,ts_usuario = hs_usuario,
	   ...
	   --ref04 Fin
           ts_tipo_chequera = hs_tipo_chequera,ts_aporte_iess = hs_aporte_iess,ts_descuento_iess = hs_descuento_iess,ts_fonres_iess = hs_fonres_iess,'0' /*<REF 05 lcepeda REF 05>*/
      ...
      where @reproceso = 'S'
		...
		and hs_secuencial in (100552805,100552812, 100552822,100552935,100552942,100552947,100553113,100553119,100553133, 100553142)
