...
/*6    20/Mar/2022     Kevin Bastidas RECMPS-14782 PAGO TERCON - TERMINAL DE CONTENEDORES EN VENTANILLA*/
/************************************************************************/
...
--Kbastida Add @@rowcount por else RECMPS-14782
else
--if @@rowcount = 0
begin
