...
Private Sub cmdBoton_Click(Index As Integer)
    ...
    Select Case Me.txt_empresa.text
        ...
        Case "1342", "8456", "8457", "19574", "19575" 'kbastidz Compra Paquete Movistar Tuenti Broadnet Recargas
        Case Else
  ...
  Select Case Index
    Case 0  'Buscar
      ...
      Select Case Trim(Me.txt_empresa.text)
        ...
        Case "1342", "8456", "8457", "19574", "19575" 'kbastidz Compra Paquete Movistar 'dolayas BROADNET
            PLBuscarBroadnet (0)
          Case VLEmpTvCable
              PLBuscarTVCABLE (0)
...
'            PLConfirmaEMELGUR          'Confirmacion de Concialicion CATEG
        ...
        Case 1342, 8456, 8457, 19574, 19575 'kbastidz Compra Paquete Movistar
            If cmdEstadoBco.text <> "TODOS" Then
                MsgBox "Los estados de Banco y Empresa debe indicar: TODOS", vbInformation + vbOKCancel, "TSERVI"
               Exit Sub
            End If
...
'             PLExportaExcelCATEG
        ...
        Case "1342", "8456", "8457", "19574", "19575" 'kbastidz Compra Paquete Movistar 'Ref 05
...
'          End If
        ...
        Case "1342", "8456", "8457", "19574", "19575" 'kbastidz Compra Paquete Movistar 'RECARGAS BROADNET
            PLProcesarBroadnet
...
Private Sub PLBuscaIessOK(orden As Long) 'archExcIessOK
   ...
   If FMTransmitirRPC(SqlConn&, ServerName$, "cob_pagos", "sp_concilia_iess", True, "Ok... Consulta de Pagos IESS") Then
      If orden = 0 Then
         PgMapeaFlexG grdAlterno, True, False, 0, 15, 17 'KBastidz Updt 16-17
      Else
         PgMapeaFlexG grdAlterno, False, False, 0, 15, 17 'KBastidz Updt 16-17
      End If
      PMChequea SqlConn&
      If Me.grdAlterno.Tag = "15" Then
         Me.grdAlterno.Col = 14
...
On Error GoTo ErrorHandler
        ...
        For iRow = 1 To Me.grdAlterno.Rows - 1
            ...
            grdAlterno.Col = 1
            oWs.Cells(16 + iRow, 1).Value = grdAlterno.text 'fecha
            fecha = grdAlterno.text
                        
            grdAlterno.Col = 2
            oWs.Cells(16 + iRow, 2).Value = grdAlterno.text 'ciudad

            grdAlterno.Col = 3
            oWs.Cells(16 + iRow, 3).Value = grdAlterno.text ' agencia

            grdAlterno.Col = 4
            oWs.Cells(16 + iRow, 4).Value = grdAlterno.text ' canal

            grdAlterno.Col = 5
            oWs.Cells(16 + iRow, 5).Value = grdAlterno.text 'cod_cajero

            grdAlterno.Col = 6
            oWs.Cells(16 + iRow, 6).Value = grdAlterno.text  ' monto total

            grdAlterno.Col = 7
            vlefectivo = CCur(IIf(grdAlterno.text = "", 0, grdAlterno.text))    'tc 09172009
            oWs.Cells(16 + iRow, 7).Value = grdAlterno.text   ' efectivo
            totEfectivo = totEfectivo + CCur(vlefectivo)

            grdAlterno.Col = 8
            vlcheque = CCur(IIf(grdAlterno.text = "", 0, grdAlterno.text))    'tc 09172009
            oWs.Cells(16 + iRow, 8).Value = grdAlterno.text  ' cheque
            totCheque = totCheque + CCur(vlcheque)
            
            grdAlterno.Col = 9
            vlnd = CCur(IIf(grdAlterno.text = "", 0, grdAlterno.text))    'tc 09172009
            oWs.Cells(16 + iRow, 9).Value = grdAlterno.text  ' N/D
            totND = totND + CCur(vlnd)
            
            'KBastidz Ini
            grdAlterno.Col = 16
            vltc = CCur(IIf(grdAlterno.text = "", 0, grdAlterno.text))    'TC
            oWs.Cells(16 + iRow, 10).Value = grdAlterno.text
            TotalTC = TotalTC + CCur(vltc)
            'KBastidz Ini

            grdAlterno.Col = 10
            oWs.Cells(16 + iRow, 11).Value = grdAlterno.text ' hora

            grdAlterno.Col = 11
            oWs.Cells(16 + iRow, 12).Value = grdAlterno.text ' cedula /RUC

            grdAlterno.Col = 12
            oWs.Cells(16 + iRow, 13).Value = grdAlterno.text ' Nombre

            grdAlterno.Col = 13
            oWs.Cells(16 + iRow, 14).Value = grdAlterno.text ' codigo_3 -- rubro
            
            grdAlterno.Col = 6
            oWs.Cells(16 + iRow, 15).Value = grdAlterno.text
            
            grdAlterno.Col = 6 'kabstidz Update
            oWs.Cells(16 + iRow, 16).Value = grdAlterno.text
            
            grdAlterno.Col = 15
            oWs.Cells(16 + iRow, 17).Value = grdAlterno.text
...
On Error GoTo ErrorHandler
        ...
        For iRow = 1 To Me.grdAlterno.Rows - 1
            ...
            grdAlterno.Col = 10
            oWs.Cells(16 + iRow, 10).Value = grdAlterno.text ' hora

            grdAlterno.Col = 11
            oWs.Cells(16 + iRow, 11).Value = grdAlterno.text ' cedula /RUC

            grdAlterno.Col = 12
            oWs.Cells(16 + iRow, 12).Value = grdAlterno.text ' Nombre

            grdAlterno.Col = 13
            oWs.Cells(16 + iRow, 13).Value = grdAlterno.text ' codigo_3 -- rubro
            
            grdAlterno.Col = 6
            oWs.Cells(16 + iRow, 14).Value = grdAlterno.text
